...
distributeButton.addEventListener('click', function() {
  ...
  fetch('/api/members/total')
    ...
    .then(data => {
      ...
      var members = Array.from(document.querySelectorAll('#members-container > div'));
      ...
      for (var i = 0; i < peopleCounts.length; i++) {
        ...
        // テーブル要素を取得
        var tableContainer = document.querySelector('#container > .table-container:nth-child(' + (i + 1) + ')');

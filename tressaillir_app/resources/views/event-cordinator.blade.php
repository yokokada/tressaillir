...
<body>
  ...
  <form action="{{ url('event-register') }}" method="post" class="container mx-auto p-14">
    ...
    <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
      ...
      <div class="col-span-2">
        <button class="mt-14 absolute left-1/2 transform -translate-x-1/2 px-24 py-6 bg-red-600 hover:bg-yellow-300 text-white text-2xl font-bold rounded-2xl" type="submit">登録</button>
      </div>
    </div>
  </form>
  <script>

    ...
    <div class="flex flex-col items-center text-gray-700" style="text-align: center;">
        <div class="container mx-auto p-8" style="text-align: center;">
            ...
            <div class="grid grid-cols-1 gap-4 sm:grid-cols-2" style="text-align: center;">
                    ...
                    <label class="block text-lg">
                        ...
                        <div class="flex items-center">
                            <input name="event"
                                ...
                                type="text" id="amount" placeholder="">
                ...
                <div>
                    <label class="block">
                        <p class="text-lg flex justify-center">割り勘人数は<input id="totalMembers"
                                class="border border-gray-400 rounded-lg px-2 py-1" input class="peopleInput"
                                type="number" min="1" max="{{ $total }}" value="{{ $total }}">人です</p>
                ...
                <div class="col-span-2">
                    <button id="calculate"
                        class="w-full py-2 bg-red-600 hover:bg-yellow-400 text-white text-xl font-bold rounded-lg mt-2">割り勘額確認！</button>
                ...
                <div class="col-span-2">
                    <button id="send-btn"
                        class="w-3/4 py-2 bg-red-600 hover:bg-yellow-400 text-white text-xl font-bold rounded-lg mt-2"
                        type="submit">みんなに送信！</button>
